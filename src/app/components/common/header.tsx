      ...
      <div className="relative container px-6 pt-20 md:pt-32">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div>
            ...
            <p className="text-gray-300 text-md md:text-lg leading-relaxed animate-fade-in-up">A Fresh Graduate from Informatics at Institut Teknologi Sepuluh Nopember, passionate about crafting robust backend solutions and websites.</p>

            <div className="flex flex-col md:flex-row gap-4 animate-fade-in-up" style={{ animationDelay: "0.4s" }}>
              <a href="#PROJECTS" className="px-6 py-3 bg-cyan-500 hover:bg-cyan-600 text-gray-900 font-medium rounded-lg transition-all transform hover:scale-105 text-center">
                View Projects
              </a>
              <a href="#CONTACT" className="px-6 py-3 border border-cyan-400 text-cyan-400 hover:bg-cyan-400/10 rounded-lg transition-all text-center">
                Contact Me
              </a>
            </div>
          </div>
          ...
          <div className="relative h-[300px] md:h-[500px] hidden md:block">
            ...
            <FloatingIcon icon={SiPostgresql} x={60} y={20} delay={0.5} color="#336791" text="PostgreSQL" />
            <FloatingIcon icon={SiMysql} x={70} y={45} delay={1} color="#00758F" text="MySQL" />
            <FloatingIcon icon={SiGit} x={20} y={45} delay={1} color="#F05032" text="Git" />
            <FloatingIcon icon={SiDotnet} x={30} y={70} delay={1} color="#512BD4" text=".NET" />
            <FloatingIcon icon={SiDocker} x={60} y={70} delay={1.5} color="#0DB7ED" text="Docker" />
          </div>
        </div>
      </div>
    </section>
